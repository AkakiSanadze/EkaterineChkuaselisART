...
(function () {
    ...
    const artworkDatabase = [
        ...
        { id: 'freeze', title: 'Freeze', category: 'oil', technique: 'Oil, Canvas', size: '30x45cm', year: '', image: 'images/freeze oil on canvas.jpg', description: 'A frozen moment captured in oil paint, depicting stillness and contemplation.' },
        { id: 'girl-bird', title: 'Girl & Bird', category: 'oil', technique: 'Oil, Canvas', size: '30x45cm', year: '2008', image: 'images/girl bird oil on canvas.jpg', description: 'An oil painting showing a girl with a bird, symbolizing freedom and connection.' },
        { id: 'spring', title: 'Spring', category: 'oil', technique: 'Oil, Canvas', size: '30x45cm', year: '2008', image: 'images/spring.jpg', description: 'An oil painting capturing the essence and renewal of spring season.' },
        { id: 'still-life', title: 'Still life', category: 'oil', technique: 'Oil, Canvas', size: '20x70cm', year: '', image: 'images/still-life.jpg', description: 'A classic still life oil painting of arranged objects.' },
        { id: 'ginger-color', title: 'Ginger Color', category: 'oil', technique: 'Oil, Canvas', size: '45x35cm', year: '2005', image: 'images/Ginger Color.jpg', description: 'A warm-toned oil painting with rich ginger hues.' },
        ...
        { id: 'still-life-2011', title: 'Still Life', category: 'oil', technique: 'Oil, Canvas', size: '45x60cm', year: '2011', image: 'images/Still Life.jpg', description: 'A traditional still life oil painting from 2011.' },
        { id: 'sheep', title: 'Sheep', category: 'oil', technique: 'Oil, Canvas', size: '40x60cm', year: '', image: 'images/sheep.jpg', description: 'An oil painting of sheep in a pastoral setting.' },
        { id: 'missing', title: 'Missing', category: 'oil', technique: 'Oil, Canvas', size: '30x45cm', year: '', image: 'images/Missing.jpg', description: 'An evocative oil painting suggesting absence and longing.' },
        ...
        { id: 'flowers', title: 'Flowers', category: 'oil', technique: 'Oil, Canvas', size: '60x80cm', year: '2003', image: 'images/Flowers.jpg', description: 'A colorful oil painting of flower arrangement from 2003.' },
        { id: 'my-green-space', title: 'My Green Space', category: 'oil', technique: 'Oil, Canvas', size: '60x60cm', year: '2008', image: 'images/My-Green-Space.jpg', description: 'An oil painting of verdant natural space.' },
        { id: 'we', title: 'We', category: 'oil', technique: 'Oil, Canvas', size: '30x30cm', year: '2008', image: 'images/We.jpg', description: 'An intimate oil painting suggesting togetherness.' },
        { id: 'the-bird', title: 'The Bird', category: 'oil', technique: 'Oil, Canvas', size: '50x60cm', year: '2008', image: 'images/the-bird.jpg', description: 'An oil painting featuring a bird.' },
        { id: 'blindly-spring', title: 'Blindly Spring', category: 'oil', technique: 'Oil, Canvas', size: '30x40cm', year: '2008', image: 'images/blindly-spring.jpg', description: 'A spring-themed oil painting from Tbilisi private collection.' },
        { id: 'dream', title: 'Dream', category: 'oil', technique: 'Oil, Canvas', size: '40x50cm', year: '2008', image: 'images/Dream.jpg', description: 'A dreamlike oil painting from 2008.' },
        { id: 'still-life-2008', title: 'Still Life', category: 'oil', technique: 'Oil, Canvas', size: '35x50cm', year: '2008', image: 'images/still-life2.jpg', description: 'A classic still life oil painting from 2008.' },
        { id: 'with-crane', title: 'With Crane', category: 'oil', technique: 'Oil, Canvas', size: '50x60cm', year: '2008', image: 'images/with-crane.jpg', description: 'An oil painting featuring a crane bird.' },
        { id: 'the-flowers', title: 'The Flowers', category: 'oil', technique: 'Oil, Canvas', size: '40x50cm', year: '2008', image: 'images/the-flowers.jpg', description: 'An elegant oil painting of flowers.' },
        { id: 'doll-5', title: 'Doll', category: 'oil', technique: 'Oil, Canvas', size: '20x25cm', year: '2005', image: 'images/doll-5.jpg', description: 'An oil painting of a doll figure.' },
        { id: 'doll-1', title: 'Doll', category: 'oil', technique: 'Oil, Canvas', size: '25x30cm', year: '2005', image: 'images/doll-1.jpg', description: 'An oil painting of a doll from 2005.' },
        { id: 'doll-2', title: 'Doll', category: 'oil', technique: 'Oil, Canvas', size: '25x30cm', year: '2005', image: 'images/doll-2.jpg', description: 'Another doll painting from 2005.' },
        { id: 'doll-4', title: 'Doll', category: 'oil', technique: 'Oil, Canvas', size: '45x67cm', year: '2005', image: 'images/doll-4.jpg', description: 'A larger doll painting from 2005.' },
        { id: 'doll-3', title: 'Doll', category: 'oil', technique: 'Oil, Canvas', size: '45x65cm', year: '2005', image: 'images/doll-3.jpg', description: 'A figurative doll painting from 2005.' },
        { id: 'doll-6', title: 'Doll', category: 'oil', technique: 'Oil, Canvas', size: '45x67cm', year: '2005', image: 'images/doll-6.jpg', description: 'A portrait-oriented doll painting from 2005.' },
        { id: 'folk-instruments', title: 'Folk instruments', category: 'oil', technique: 'Oil, Canvas', size: '20x35cm', year: '2005', image: 'images/folk-instruments.jpg', description: 'An oil painting of traditional Georgian musical instruments.' },
        { id: 'jester', title: 'Jester', category: 'oil', technique: 'Oil, Canvas', size: '40x60cm', year: '2005', image: 'images/Jester.jpg', description: 'A colorful oil painting of a court jester.' },
        { id: 'hedgehog', title: 'Hedgehog', category: 'oil', technique: 'Oil, Canvas', size: '50x70cm', year: '2005', image: 'images/Hedgehog.jpg', description: 'A charming oil painting of a hedgehog from Moscow private collection.' },
        { id: 'cuca', title: 'Cuca', category: 'oil', technique: 'Oil, Canvas', size: '70x100cm', year: '2005', image: 'images/Cuca.jpg', description: 'A large-format oil painting titled Cuca from Moscow private collection.' },
        { id: 'tree', title: 'Tree', category: 'oil', technique: 'Oil, Canvas', size: '40x60cm', year: '2005', image: 'images/Tree.jpg', description: 'An oil painting of a tree from Moscow private collection.' },
        { id: 'tojina', title: 'Doll', category: 'oil', technique: 'Oil, Canvas', size: '90x90cm', year: '2005', image: 'images/tojina.jpg', description: 'A large square-format doll painting from Moscow private collection.' },
        { id: 'thought', title: 'Thought', category: 'oil', technique: 'Oil, Canvas', size: '45x65cm', year: '2005', image: 'images/Thought.jpg', description: 'A contemplative oil painting from Moscow private collection.' },
        { id: 'still-life-moscow', title: 'Still Life', category: 'oil', technique: 'Oil, Canvas', size: '40x60cm', year: '2005', image: 'images/still-life-moscow-private-collection.jpg', description: 'A classic still life oil painting from Moscow private collection.' },
        { id: 'winter-moscow', title: 'Winter', category: 'oil', technique: 'Oil, Canvas', size: '35x55cm', year: '2005', image: 'images/Winter1.jpg', description: 'A winter scene oil painting from Moscow private collection.' },
        { id: 'one-two-three', title: 'One, two, three', category: 'oil', technique: 'Oil, Canvas', size: '35x50cm', year: '2005', image: 'images/One-two-three.jpg', description: 'A sequential composition oil painting from Moscow private collection.' }
    ];
